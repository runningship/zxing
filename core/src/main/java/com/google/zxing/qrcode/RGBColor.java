...
public class RGBColor {
    ...
    public boolean equals(Object obj) {
        return obj instanceof RGBColor && ((RGBColor)obj).getRGB() == this.getRGB();
    }
     ...
     * @since    1.0
     */
    public static RGBColor getColor(String nm, RGBColor v) {
     ...
     * @since    1.0
     */
    public static RGBColor getColor(String nm, int v) {
        Integer intval = Integer.getInteger(nm);
        int i = (intval != null) ? intval.intValue() : v;
        return new RGBColor((i >> 16) & 0xFF, (i >> 8) & 0xFF, (i >> 0) & 0xFF);
    }
